...
class SegEvaluator(Evaluator):
    ...
    def compute_metric(self, results):
        ...
        iu, mean_IU, _, mean_pixel_acc, precision, recall = compute_score(hist, correct,
                                                       labeled)
        print(len(dataset.get_class_names()))
#         print ('average_k', average_k, 'impurity', impurity)
        result_line = print_iou(iu, mean_pixel_acc, precision, recall,
